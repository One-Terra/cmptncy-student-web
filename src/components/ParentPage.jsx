        ...
        <div className={styles.contentContainer}>
          <div className={styles.page}>
            <div className={styles.formHeader}>
              ...
              <p className={styles.formSubtitle}>Free · No login needed for your child · Results sent to you by email</p>
            </div>
            ...
            <div className={styles.formBody}>
              <form onSubmit={handleSubmit}>
                ...
                <div className={styles.rowHintCenter}>We'll send you their results as soon as they're done.</div>
                ...
                <div className={styles.rowHintCenter}>No account needed on their end.</div>
