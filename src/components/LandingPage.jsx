          ...
          <div className={styles.hero}>
            <div className={styles.heroLeft}>
              ...
              <div className={styles.heroActions}>
                <Link to="/register" className={styles.heroBtn}>Ready? Let's find out for free.</Link>
              </div>
      ...
      <section id="how-it-works" className={styles.tilesSection}>
        <div className={styles.container}>
          <div className={styles.tilesWrap}>
            <div className={styles.secLabel}>What CMPTNCY does</div>
      ...
      <section id="pricing" className={styles.tiersSection}>
        <div className={styles.container}>
          <div className={styles.tiersWrap}>
            <div className={styles.secLabel}>How it grows with you</div>
            <div className={styles.tiersGrid}>
              ...
              {/* FULL PLAN */}
              <div className={`${styles.tier} ${styles.hot}`}>
                <div className={styles.th}>
                  <div className={styles.thTop}>
